...
<div class="d-flex flex-row mt-2 p-3 mb-5" style="height:auto;width:auto;">

	

   <div class=" align-self-center ml-auto mr-auto mb-5 form-con " >
   <form class="text-center  text-gray-dark p-0" action="mobileserver.jsp" method="post">
 	<h1 class="badge-pill badge-warning text-capitalize">login</h1>
<%
 try{
...
%>
  <div class="form-group">
    ...
    <input type="text" name="number" class="form-control" id="exampleInputEmail1" placeholder="&#128222;Phone number" aria-describedby="emailHelp">
    <small id="emailHelp" class="form-text">We'll never share your contact detail with anyone else.</small>
  </div>
  <div class="form-group">
  ...
  <div class="d-flex"><button type="submit" class="btn flex-fill" id="demo1">Submit</button></div>
